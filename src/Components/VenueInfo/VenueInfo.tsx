        ...
        >
          ...
          >
            ...
            >
              ...
              <Typography sx={{ color: darkMode ? Colours.darkText : Colours.lightText }}>
                We suggest bringing your own alcohol, however should you want to go to a pub you can
                check out the Royal Oak located a few minutes walk from the hall, more details on
                their website {''}
                <a
            ...
            >
              ...
              <Typography sx={{ color: darkMode ? Colours.darkText : Colours.lightText }}>
                ShinyLAN has a social area where you can get away from the glow of your screen. Play
                board games, enjoy the organised events such as the pub quiz or poker tourney.
                Chairs & tables are provided
              </Typography>
            </Stack>
          </Stack>
        </Grid>
